  ...
  return (
    <div className='bg-[#1f0733] text-white '>
      <div className='flex mb-20 flex-col justify-center items-center mx-[100px]'>
        ...
        <p className='text-[14px]'>By clicking “Sign me up” I have read and agree to Indiegogo’s <u>Terms of Use</u> and Privacy Policy .
    ...
    <div className='flex justify-between mt-10 pb-10 gap-4 mx-20'>

      <div className=' gap-20 flex flex-col '>
       <p className='text-xl mb-4 max-w-[70%]'>Supporting needed, creators and creative communities since 2025</p>
       <div>
